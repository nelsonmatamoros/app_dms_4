...
function prevForm(vIdForm, vFlag){
    ...
    try{
        if(vFlag == 0){
            ...
            StrHtml += '<hr /><table width="100%"><tr><td width="50%"><button id=\'sendForm\' onclick="envioForm(this)" data-theme="b">Enviar</button></td>';
            StrHtml += '<td><button id=\'saveForm\' onclick="guardarForm(this)" data-theme="a">Guardar</button></td></tr></table><br />';
